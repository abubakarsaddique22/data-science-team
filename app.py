...
visualization_agent = Agent(
    ...
    read_chat_history=True,
    instructions=[
        "You are an expert in creating plots using matplotlib",
    ...
    tools=[PandasTools(),FileTools(base_dir=base_dir),VisualizationTools("chats")]
)
...
coding_agent = Agent(
    ...
    instructions=[
        "you are an expert coding agent proficient in writing python code",
...
shell_agent = Agent(
    ...
    instructions=[
        "You have the capability to run shell commands",
...
data_science_team = Team(
    ...
    instructions=[
        "You are an expert Data Scientist and a team leader",
